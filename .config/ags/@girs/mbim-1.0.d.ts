...
declare module 'gi://Mbim?version=1.0' {
    ...
    export namespace Mbim {
         ...
         * @returns a string with the list of nicknames, or %NULL if none given. The returned value should be freed with g_free().
         */
        function ip_configuration_available_flag_build_string_from_mask(
            mask: IPConfigurationAvailableFlag | null,
        ): string;
        /**
        ...
        class Message {
            ...
            static auth_akap_query_new(
                rand: Uint8Array | string,
                autn: Uint8Array | string,
                network_name: string,
            ): Message;
            ...
            static ms_basic_connect_extensions_device_slot_mappings_set_new(
                map_count: number,
                slot_map: Slot[],
            ): Message;
            ...
            ms_basic_connect_extensions_lte_attach_status_notification_parse(): [
                boolean,
                DeprecatedLteAttachStatus | null,
            ];
            /**
