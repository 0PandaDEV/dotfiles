...
declare module 'gi://AstalRiver?version=0.1' {
    ...
    export namespace AstalRiver {
        ...
        namespace Layout {
            ...
            interface NamespaceInUse {
                (output: Output): void;
            }

            interface UserCommand {
                (command: string, output: Output): void;
            }
        ...
        class Layout extends GObject.Object {
            ...
            connect(signal: 'namespace-in-use', callback: (_source: this, output: Output) => void): number;
            connect_after(signal: 'namespace-in-use', callback: (_source: this, output: Output) => void): number;
            emit(signal: 'namespace-in-use', output: Output): void;
            connect(signal: 'user-command', callback: (_source: this, command: string, output: Output) => void): number;
            connect_after(
                signal: 'user-command',
                callback: (_source: this, command: string, output: Output) => void,
            ): number;
            emit(signal: 'user-command', command: string, output: Output): void;
